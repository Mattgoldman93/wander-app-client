...
define('ga-wdi-boston.ember-auth/tests/unit/initializers/text-field-test', ['exports', 'ember', 'wander/initializers/text-field', 'qunit'], function (exports, _ember, _wanderInitializersTextField, _qunit) {
  ...
  (0, _qunit.test)('it works', function (assert) {
    _wanderInitializersTextField['default'].initialize(application);
...
require('wander/tests/test-helper');
