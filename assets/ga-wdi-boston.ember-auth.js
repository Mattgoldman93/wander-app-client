...
define('ga-wdi-boston.ember-auth/adapters/application', ['exports', 'wander/config/environment', 'active-model-adapter', 'ember'], function (exports, _wanderConfigEnvironment, _activeModelAdapter, _ember) {
  exports['default'] = _activeModelAdapter['default'].extend({
    host: _wanderConfigEnvironment['default'].apiHost,
...
define('ga-wdi-boston.ember-auth/initializers/data-adapter', ['exports'], function (exports) {
  /*
...
define('ga-wdi-boston.ember-auth/initializers/ember-data', ['exports', 'ember-data/setup-container', 'ember-data'], function (exports, _emberDataSetupContainer, _emberData) {
...
define('ga-wdi-boston.ember-auth/initializers/injectStore', ['exports'], function (exports) {
  /*
    This initializer is here to keep backwards compatibility with code depending
...
define('ga-wdi-boston.ember-auth/initializers/store', ['exports'], function (exports) {
  /*
    This initializer is here to keep backwards compatibility with code depending
...
define('ga-wdi-boston.ember-auth/initializers/transforms', ['exports'], function (exports) {
  /*
    This initializer is here to keep backwards compatibility with code depending
...
define("ga-wdi-boston.ember-auth/instance-initializers/ember-data", ["exports", "ember-data/instance-initializers/initialize-store-service"], function (exports, _emberDataInstanceInitializersInitializeStoreService) {
  exports["default"] = {
    name: "ember-data",
...
define('ga-wdi-boston.ember-auth/services/ajax', ['exports', 'ember', 'ember-ajax/services/ajax', 'wander/config/environment'], function (exports, _ember, _emberAjaxServicesAjax, _wanderConfigEnvironment) {
...
define('wander/config/environment', [], function() {
  var prefix = 'wander';
try {
...
if (!runningTests) {
  require("wander/app")["default"].create({"name":"ga-wdi-boston.ember-auth","version":"0.0.0+8ea9ceba"});
}
